...
| `CORS_ALLOWED_ORIGINS` | `https://boys-bank.vercel.app` | Comma-separated list of frontend origins allowed to call the API. Add localhost only for local/dev use. Do not include a trailing slash. |
...
| `CORS_ALLOWED_ORIGINS` | `https://boys-bank.vercel.app` |
